...
faq = {
    ...
    "觀看照片": ImageMessage(
        original_content_url="https://sdl-stickershop.line.naver.jp/products/0/0/4/1021884/LINEStorePC/main.png?__=20161019",
        preview_image_url="https://sdl-stickershop.line.naver.jp/products/0/0/4/1021884/LINEStorePC/main.png?__=20161019"
    ),
...
menu = TemplateMessage(
    ...
    template=CarouselTemplate(
        columns=[
            CarouselColumn(
                # 卡片一圖片網址
                thumbnail_image_url="https://images.radio.com/aiu-media/3BodyProblem-9d3f5b50-eb56-4e15-ba64-8823286f66ef.jpg?width=800",
                title="主選單一",
                text="點選下方按鈕開始互動",
                actions=[
                    MessageAction(
            ...
            CarouselColumn(
                # 卡片二圖片網址
                thumbnail_image_url="https://deadline.com/wp-content/uploads/2024/03/3_Body_Problem_n_S1_E3_00_05_31_10R.jpg",
                title="主選單二",
                text="點選下方按鈕開始互動",
                actions=[
                    MessageAction(
